...
if __name__ == "__main__":
    ...
    while True:
        ...
        q1.append(bot.joint[HIP_YAW_R]["q"])
        q2.append(bot.joint[HIP_ROLL_R]["q"])
        q3.append(bot.joint[HIP_PITCH_R]["q"])
        q4.append(bot.joint[KNEE_PITCH_R]["q"])
        q5.append(bot.joint[ANKLE_PITCH_R]["q"])
