...
def initMain():
    ...
    mode = "s" #input("Go to standing (s) or nominal (n) posture? ")
    if mode == "n":
        # arm pose
        ar1, ar2, ar3 = 0., 0., 0.
        al1, al2, al3 = 0., 0., 0.
        ...
        # leg pose
        bpr = np.array([0.080, -0.070, -0.42])  # right foot position  in body frame
        bpl = np.array([0.080, +0.070, -0.42])  # left  foot position  in body frame
    ...
    Ns   = 100
    freq = 100  # [Hz]
    set_joint_positions(bot, Ns, 1. / freq,
