        ...
        if gm.is_connected:
            ...
            if booted:
                if (gm.button["LZ"] and gm.button["RZ"]) or thread_error:
                    booted = False
                    os.system("gnome-terminal -- "/home/khadas/BRUCE/BRUCE-OP/terminate.sh"")
                ...
                if gm.button["LZ"] and gm.button["ST"]:
                    ...
                    os.system("gnome-terminal -- "/home/khadas/BRUCE/BRUCE-OP/bootup_gamepad.sh"")
                    print("")
