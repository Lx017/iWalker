...
class GamepadManager(object):
    def __init__(self, mac="E0:5A:1B:D1:01:76"):
        ...
        # data from gamepad
        # [0xFF(1), REST_LENGTH(1), 0bUDLRABXY(1), 0b{LZ}{LS}{LSP}{LSM}{RZ}{RS}{RSP}{RSM}(1), 0b0000{ST}{BK}{ALT}{FN}(1), LX(1), LY(1), RX(1), RY(1), CHECKSUM(1), 0xFE(1)]
        ...
        self.button = {"U":   0,  # HAT_UP
                       ...
                       "LZ":  0,  # L_AXIS_Z
                       "LS":  0,  # L_SHOULDER
                       "LSP": 0,  # L_SHOULDER_PLUS
                       "LSM": 0,  # L_SHOULDER_MINUS
                       "RZ":  0,  # R_AXIS_Z
                       "RS":  0,  # R_SHOULDER
                       "RSP": 0,  # R_SHOULDER_PLUS
                       "RSM": 0,  # R_SHOULDER_MINUS
